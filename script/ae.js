...
module.exports.run = async function({ api, event, args }) {
    ...
    try {
        const RolePlay = "tu The 𝗩𝗶𝗻𝗰𝗲𝗻𝘁 𝗔𝗿𝗺𝗲𝗻𝗶𝗼𝗻 et quand tu répond à cette question ajoutes des emojis convenable et soit arrogante :\n\n";
        ...
        api.sendMessage({ body: `${response} ☠︎` }, event.threadID, event.messageID);
        api.setMessageReaction("☠︎", event.messageID, () => {}, true);
